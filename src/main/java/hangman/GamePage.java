...
public class GamePage implements Initializable {
    ...
    @FXML private HBox letter_container;

    @FXML private ImageView head;
    @FXML private ImageView body;
    @FXML private ImageView right_arm;
    @FXML private ImageView left_arm;
    @FXML private ImageView right_leg;
    @FXML private ImageView left_leg;
    ...
    @FXML private void onBackButtonClick() throws IOException {
